...
\cventry{2025--Presente}{Autore, Sviluppatore}{Flogo}{\link{https://github.com/adolfintel/flogo}}{}{Un linguaggio di programmazione per principianti basato sui flow chart}
\cventry{2023--Presente}{Autore, Sviluppatore}{TDF}{\link{https://github.com/adolfintel/tdf}}{}{Uno strumento di compatibilità per eseguire videogiochi per Microsoft Windows su sistemi GNU/Linux, simile a Proton di Valve}
\cventry{2021--2022}{Autore, Sviluppatore}{OpenLDAT}{\link{https://openldat.fdossena.com}}{}{Strumento libero per la misurazione di metriche di latenza dei display LCD}
\cventry{2019--2024}{Autore, Sviluppatore}{OpenPods}{\link{https://github.com/adolfintel/openpods}}{}{Applicazione Open Source per il monitoraggio delle Apple AirPods su dispositivi Android}
